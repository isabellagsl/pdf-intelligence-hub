...
- **PyMuPDF**: Motor principal (High-performance extraction) para leitura rápida de textos brutos.
...
│   ├── models/         # Definições de Schemas (Data Contracts)
...
# Execute o pipeline (Exemplo)
poetry run python src/main.py --input sample.pdf
```
